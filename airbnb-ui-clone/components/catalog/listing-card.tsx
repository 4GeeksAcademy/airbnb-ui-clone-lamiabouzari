...
export function ListingCard({
  ...
  return (
    <article className="flex gap-4 rounded-2xl border border-neutral-200 bg-white p-4 transition hover:shadow-md">
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        <div className="flex items-start justify-between gap-3">
          ...
          <button type="button" className="text-lg text-neutral-500">♡</button>
        </div>
